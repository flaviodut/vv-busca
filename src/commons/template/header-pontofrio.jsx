...
import LogoPontofrio from '../../commons/assets/pf/logo-pontofrio.svg'
import IconCart from '../../commons/assets/pf/ic-cart.svg'
import IconProfile from '../../commons/assets/pf/ic-profile.svg'
import IconSearch from '../../commons/assets/pf/ic-search.svg'
            ...
            <Grid cols="12">
              <div className="d-flex flex-wrap flex-md-nowrap justify-content-between align-items-center">
                <Logo className="mr-md-5 order-0 order-md-0">
                  <a href="/">
                    <ReactSVG src={LogoPontofrio} wrapper="span" />
                  </a>
                </Logo>
